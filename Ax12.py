...
from dxl_control2.ax12_control_table import *  # Uses ax12 Control Table
import threading
import time
...
class Ax12:
    ...
    DEVICENAME = "COM6"           # Default COM Port
    ...
    def set_cw_angle_limit(self, cw_angle_limit):
        """Sets Torque Limit of Motor."""
        self.set_register2(ADDR_AX_CW_ANGLE_LIMIT_L, cw_angle_limit)

    def set_ccw_angle_limit(self, ccw_angle_limit):
        """Sets Torque Limit of Motor."""
        self.set_register2(ADDR_AX_CCW_ANGLE_LIMIT_L, ccw_angle_limit)
